...
const CommentBox = ({ data, commentProps }) => {
  ...
  return (
    <div className="relative bg-[#9bf5d4] border-2 border-zinc-400 p-2 rounded flex flex-col gap-2">
      <div className="flex justify-between items-center flex-wrap">
        <div className="bg-[#e5fcde] rounded px-2 py-1">{data.displayname}</div>
