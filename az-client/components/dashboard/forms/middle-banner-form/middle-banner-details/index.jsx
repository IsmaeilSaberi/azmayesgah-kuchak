...
const MiddleBannerDetails = ({ middleBannerId }) => {
  ...
  const updater = (e) => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/update-middle-banner/${middleBannerId}`,
        formData,
        {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/get-middle-banner/${middleBannerId}`,
        {
          headers: { auth_cookie: auth_cookie },
        }
      )
  ...
  const remover = (e) => {
    axios
      .post(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/remove-middle-banner/${middleBannerId}`,
        { item: 1 },
        {
          headers: { auth_cookie: auth_cookie },
        }
