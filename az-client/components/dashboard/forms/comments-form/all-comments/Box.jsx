...
const Box = ({ data, setCommentDetailCtrl, setRandNumForCommentClick }) => {
  ...
  return (
    <div
      ...
      className="relative flex justify-start gap-8 items-center w-full h-32 cursor-pointer p-6 rounded-lg border-2 border-zinc-200 bg-[#9bf5d4] transition-all duration-200 hover:border-orange-500"
    >
      <div className="flex w-full flex-col gap-4">
        ...
        <div className="absolute bottom-3 left-3 flex justify-end items-center gap-2">
          {data.published == true ? (
            <div className="text-xs bg-[#2357b1] text-white flex justify-center items-center w-28 h-6 rounded">
              منتشر شده
            </div>
          ) : (
