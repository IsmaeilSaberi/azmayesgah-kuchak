...
const PaymentDetails = ({ paymentId }) => {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/get-payment/${paymentId}`,
        {
  ...
  const updater = (e) => {
    ...
    const url = `${process.env.NEXT_PUBLIC_SERVER_URL}/api/update-payment/${paymentId}`;
    axios
      .post(url, formData, {
        headers: { auth_cookie: auth_cookie },
      })
  ...
  const remover = (e) => {
    const url = `${process.env.NEXT_PUBLIC_SERVER_URL}/api/remove-payment/${paymentId}`;
    axios
      .post(
        url,
        { item: 1 },
      ...
      {fullData[0] == -1 ? (
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-2 justify-between items-center">
            <div className="bg-[#e5fcde] rounded p-2 text-sm flex flex-col justify-center items-center gap-2">
              <div> کد پرداختی :</div>
