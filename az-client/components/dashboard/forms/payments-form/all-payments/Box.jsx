...
const Box = ({ data, setPaymentDetailCtrl, setRandNumForPaymentClick }) => {
  ...
  return (
    <div
      ...
      className="relative flex justify-start gap-8 items-center h-36 w-full cursor-pointer p-6 rounded-lg border-2 border-zinc-200 bg-[#9bf5d4] transition-all duration-200 hover:border-orange-500"
    >
